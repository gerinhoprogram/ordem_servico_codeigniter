                ...
                <table class="table table-bordered dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-cente pr-4"><?php echo ($categoria->categoria_ativa == 1 ? '<span class="badge badge-info btn-sm">Sim</span>' : '<span class="badge badge-danger btn-sm">Não</span>') ?>
                      <td class="text-right">
                        <a title="Editar" href="<?php echo base_url('categorias/editar/'.$categoria->categoria_id) ?>" class="btn btn-sm btn-primary"><i class='fas fa-edit'></i></a>
                        <a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#categoria<?php echo $categoria->categoria_id; ?>" class="btn btn-sm btn-danger"><i class='fas fa-trash-alt'></i></a>
                      </td>
                    </tr>
                      ...
                      <div class="modal fade" id="categoria<?php echo $categoria->categoria_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">Para excluir este categoria clica em "Sim".</div>
                              <div class="modal-footer">
                                <button class="btn btn-success btn-sm" type="button" data-dismiss="modal">Não</button>
                                <a class="btn btn-danger btn-sm" href="<?php echo base_url('categorias/deletar/'.$categoria->categoria_id) ?>">Sim</a>
                              </div>
                            </div>
                          </div>
                        </div>
