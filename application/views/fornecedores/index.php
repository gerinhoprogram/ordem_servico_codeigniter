        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <a title="Cadastrar" href="<?php echo base_url('fornecedores/adicionar'); ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-user-plus"></i>&nbsp;Novo</a>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $fornecedor->fornecedor_ativo ?></td>
                      <td class="text-right">
                        <a title="Editar" href="<?php echo base_url('fornecedores/editar/'.$fornecedor->fornecedor_id) ?>" class="btn btn-sm btn-primary"><i class='fas fa-user-edit'></i></a>
                      ...
                      <div class="modal fade" id="fornecedor<?php echo $fornecedor->fornecedor_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">Para excluir este fornecedor clica em "Sim".</div>
                              <div class="modal-footer">
                                <button class="btn btn-success btn-sm" type="button" data-dismiss="modal">Não</button>
                                <a class="btn btn-danger btn-sm" href="<?php echo base_url('fornecedores/deletar/'.$fornecedor->fornecedor_id) ?>">Sim</a>
                              </div>
                            </div>
                          </div>
                        </div>
