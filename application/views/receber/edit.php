            ...
            <div class="card-body">
                <form method="POST" name="form_edit" class="user">
                    <p><strong><i class="fas fa-clock"></i>&nbsp;&nbsp;Última atualização:</strong>
                        <?php echo formata_data_banco_sem_hora($conta_receber->conta_receber_data_alteracao) ?>
                    </p>
                    <fieldset class="mb-4 border p-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control" name="conta_receber_data_vencto" aria-describedby="emailHelp" value="<?php echo $conta_receber->conta_receber_data_vencto ?>">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-use-date money2" name="conta_receber_valor" aria-describedby="emailHelp" value="<?php echo $conta_receber->conta_receber_valor ?>">
                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                ...
                                <select class="form-control" name="conta_receber_status">
                                        <option value="1" <?php ($conta_receber->conta_receber_status == 1 ? 'selected' : '') ?>>Recebido</option>
                                        <option value="0" <?php ($conta_receber->conta_receber_status == 0 ? 'selected' : '') ?>>Pendente</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <button type="submit" class="btn btn-success btn-md" <?php echo ($conta_receber->conta_receber_status == 1 ? 'disabled' : '') ?>><i class="fas fa-floppy"></i>&nbsp;&nbsp;Salvar</button>
