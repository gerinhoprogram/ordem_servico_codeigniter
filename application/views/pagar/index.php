        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <a title="Cadastrar" href="<?php echo base_url('pagar/adicionar'); ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-user-plus"></i>&nbsp;Nova</a>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $conta->conta_pagar_valor ?></td>
                      <td><?php echo formata_data_banco_sem_hora($conta->conta_pagar_data_vencto) ?></td>
                      <td><?php echo ($conta->conta_pagar_status == 1 ? formata_data_banco_sem_hora($conta->conta_pagar_data_pagamento) : 'Aguardando PGT' ) ?></td>
                      <td class="text-center">
                          <?php
                              if($conta->conta_pagar_status == 1){
                                    echo'Pago';
                              }else{
                                if(strtotime($conta->conta_pagar_data_vencto) > strtotime(date('y-m-d'))){
                                    echo'A pagar';
                                }else{
                                  if(strtotime($conta->conta_pagar_data_vencto) == strtotime(date('y-m-d'))){
                                    echo'Vence hoje';
                      ...
                      <td class="text-center">
                        <a title="Editar" href="<?php echo base_url('pagar/editar/'.$conta->conta_pagar_id) ?>" class="btn btn-sm btn-primary"><i class='fas fa-user-edit'></i></a>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <a class="btn btn-danger btn-sm" href="<?php echo base_url('pagar/deletar/'.$conta->conta_pagar_id) ?>">Sim</a>
                              </div>
                            </div>
                          </div>
                        </div>
