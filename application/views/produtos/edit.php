            ...
            <div class="card-body">
                <form method="POST" name="form_edit" class="user">
                    <p><strong><i class="fas fa-clock"></i>&nbsp;&nbsp;Última atualização:</strong>
                        <?php echo formata_data_banco_sem_hora($produto->produto_data_alteracao) ?>
                    </p>
                    <fieldset class="mb-4 border p-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <input type="text" class="form-control" name="produto_descricao" aria-describedby="emailHelp" value="<?php echo $produto->produto_descricao ?>">
                        ...
                        <div class="form-group row">
                            <div class="col-md-3">
                                ...
                                <?php foreach ($marcas as $marca): ?>
                                        <option value="<?php echo $marca->marca_id ?>" 
                                            <?php echo $marca->marca_id == $produto->produto_id ? 'selected' : '' ?> 
                            ...
                            <div class="col-md-3">
                                ...
                                <?php foreach ($categorias as $categoria): ?>
                                        ...
                                        <?php echo $categoria->categoria_id == $produto->produto_id ? 'selected' : '' ?> 
                                        <?php echo $categoria->categoria_ativa == 0 ? 'disabled' : '' ?>>
                            ...
                            <div class="col-md-3">
                                ...
                                <?php foreach ($fornecedores as $fornecedor): ?>
                                        <option value="<?php echo $fornecedor->fornecedor_id ?>" 
                                            <?php echo $fornecedor->fornecedor_id == $produto->produto_id ? 'selected' : '' ?>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="produto_unidade" aria-describedby="emailHelp" value="<?php echo $produto->produto_unidade ?>">
                        ...
                        <div class="form-group row">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control money" name="produto_preco_custo" aria-describedby="emailHelp" value="<?php echo $produto->produto_preco_custo ?>">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control money" name="produto_preco_venda" aria-describedby="emailHelp" value="<?php echo $produto->produto_preco_venda ?>">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" class="form-control" name="produto_estoque_minimo" aria-describedby="emailHelp" value="<?php echo $produto->produto_estoque_minimo ?>">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" class="form-control" name="produto_qtde_estoque" aria-describedby="emailHelp" value="<?php echo $produto->produto_qtde_estoque ?>">
